...
public class bitboard {
    ...
    public static Long[][] generateAllSquaresBetween(){
    ...
    public static Long getSquaresBetween(int startIndex, int endIndex) {
